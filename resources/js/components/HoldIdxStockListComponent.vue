            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-footer text-muted">
                        <small>Currency in Indonesian Rupiah</small>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        fetchStockResources() {
            ...
            axios.get('/api/wallet/get-resource-idx-stock', {
                params: {
                    query: this.query
                }
            }).then((response) => {
        ...
        remove({stock, index}) {
            axios.post('/api/wallet/remove-idx-stock', {
                id: stock.id
            }).then((response) => {
                if (response.data.status) {
